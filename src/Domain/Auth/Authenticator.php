...
class Authenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function authenticate(Request $request): Passport
    {
        ...
        $this->lastPassport = new Passport(
            new UserBadge($email, fn (string $email) => $this->userRepository->findByUsernameForAuth($email)),
    ...
    public function onAuthenticationSuccess(
        ...
        // If they are a redirect parameter in the url,
        // we try to redirect to the asked url.
    ...
    public function onAuthenticationFailure(
        ...
        // get the current user from the credential passport.
